...
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
Future<List<SQLiteModelVccCastLog>> readsqliteVccCastLog_RecipeList(String recipe_name) async {
    Database db = await connectDatabase();
    List<SQLiteModelVccCastLog> results =  [];
    List<Map<String, dynamic>> maps = await db.rawQuery('SELECT * FROM $tbl_vcc_castlog WHERE recipe_name = ?',[recipe_name]);
...
//ลบข้อมูลจากฐานข้อมูล
  ...
  //------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    Future<void> deleteSQLiteWhereRecipeName(String recipe_name) async{    
    Database db = await connectDatabase();
   await db.delete(tbl_vcc_castlog, where: '$column_recipe_name = ?', whereArgs:[recipe_name]).then((value) {
     print('##### Success Delete $recipe_name');
   });    
  }
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
//------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
